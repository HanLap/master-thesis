...
This chapter goes into details of the use case the implemented artifact satisfies. We give an overview of the current implementation as well as all implementation variants we produced for this study. \todo{Don't like this section yet...}
